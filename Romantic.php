<?php 
	...
	$tbl_name="Movies";
	session_start();
	$query = "SELECT * FROM $tbl_name where Genre like '%Romantic%' order by ReleaseDate desc";
?>
<!DOCTYPE html>
<html>
    <head>
    	...
    	<style>
		 ...
		 input.star-31:checked ~ label.star:before
		 { 
				color: #F62;
		 }
		 label.star:hover 
		...
		<video autoplay loop muted preload="auto" id="fullscreen" poster="../img/romanticPoster.jpg">
                    ...
                    <table class="table table-bordered table-responsive table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="stars">
									  <form action="Average.php?page=Romantic"  method="post">
											...
											<input type="submit" class="button" name="submit" onclick="myFunction(jsvar)" value="Rate">
									  </form>
									</div>
								</td>
								<td>
